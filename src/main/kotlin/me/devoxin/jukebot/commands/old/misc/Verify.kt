...
//        ctx.think()
//
//        Launcher.patreonApi?.fetchPledgesOfCampaign("750822").thenAccept { users ->
//            if (users.isEmpty()) {
...
//        val pledge = if (userId in Launcher.commandClient.ownerIds) Integer.MAX_VALUE else Database.getTier(userId)
//
//        if (pledge < 3) {
//            return 0
//        }
