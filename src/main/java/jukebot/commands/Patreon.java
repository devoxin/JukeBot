...
@CommandProperties(aliases = {"donate"}, description = "Provides a link to JukeBot's Patreon", category = CommandProperties.category.MISC)
public class Patreon implements Command {

    public void execute(final Context context) {

        final MessageEmbed.Field[] fields = {
                new MessageEmbed.Field("Tier 1 ($1)", "-> Donor Role in [JukeBot's Server](https://discord.gg/xvtH2Yn)\n" +
                ...
                new MessageEmbed.Field("Tier 2 ($2)", "-> Donor Role in [JukeBot's Server](https://discord.gg/xvtH2Yn)\n" +
