...
public class LowPassFilter extends ShelfFilter {
    ...
    public LowPassFilter(FloatPcmAudioFilter downstream, int sampleRate, int channelCount, int cutoffFrequency, double boostFactor) {
